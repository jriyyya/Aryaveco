...
export default function Hero() {
  return (
    <section className="mt-28 widescreen:mx-16 flex flex-col gap-y-8 items-start mobile:text-center">
      ...
      <button className=" mobile:self-center font-medium bg-gradient-to-l from-primary to-secondary p-3 rounded-md text-back flex flex-row items-center gap-x-2 drop-shadow-lg hover:-translate-y-1 duration-300">

...
export default function Testimonials() {
  ...
  return (
    <section className="bg-background w-full px-24 py-12 mobile:py-8 mobile:px-4 mt-[10vh] mb-[3vh] border-primary border rounded-3xl flex flex-col justify-center gap-y-8 bg-opacity-60 backdrop-blur-md">

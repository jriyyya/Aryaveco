export default function Hero() {
  return (
    <section className="flex flex-col justify-center gap-y-8 mt-[10vh] w-[60%] text-center items-center">
      <div className="bg-black text-white w-max px-2 py-1 rounded-xl self-center text-xl">
        Want to buy?
      </div>
      <div className="flex flex-col justify-center gap-y-8">
        <div className="flex flex-col">
          <div className="text-5xl font-semibold text-primary self-center ">

    ...
    <div className="bg-background text-black z-10 relative w-[60vw] px-16 py-12">
      ...
      <div className="flex flex-col items-center gap-x-4">
        <div className="flex">
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <div className="font-medium">
              ...
              reprehenderit ipsum architecto corrupti minus nam distinctio
              commodi asperiores consequuntur aliquid dolores! Facere, ipsam?
            </div>
        ...
        <div className="flex flex-col">
          <div className="flex flex-col">
            <h3 className="text-primary text-xl font-semibold">Features</h3>
          </div>
        </div>
      </div>
    </div>
